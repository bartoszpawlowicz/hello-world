...
from vsearch.utils.distances_utils import pairwise_distance


def triplet_semihard_loss_param(margin=1.0, squared=False):
    def triplet_semihard_loss(labels, embeddings):
